...
{ 
    /// <summary>
    /// Infrared frame data store, uses unmanaged memory back end
    /// </summary>
    public class InfraredFrameData : IDisposable
    {
        ...
        public IntPtr DataPointer
        {
            get
            {
                if (this.dataPointer == IntPtr.Zero)
                    throw new ObjectDisposedException("InfraredFrameData");
