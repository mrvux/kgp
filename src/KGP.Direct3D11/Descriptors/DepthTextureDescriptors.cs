...
namespace KGP.Direct3D11.Descriptors
{
    ...
    public static class DepthTextureDescriptors
    {
        ...
        public static Texture2DDescription DynamicResource
        {
            get
            {
                return DescriptorUtils.GetDynamicTexture(new TextureSize(Consts.DepthWidth, Consts.DepthHeight), Format.R16_Typeless);
            }
        }
        ...
        public static Texture2DDescription ImmutableResource
        {
            get
            {
                return DescriptorUtils.GetImmutableTexture(new TextureSize(Consts.DepthWidth, Consts.DepthHeight), Format.R16_Typeless);
            }
        }
