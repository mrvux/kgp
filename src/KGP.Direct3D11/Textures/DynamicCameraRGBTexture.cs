...
namespace KGP.Direct3D11.Textures
{
    ...
    /// </summary>
    public class DynamicCameraRGBTexture : IDisposable
    {
        ...
        public DynamicCameraRGBTexture(Device device)
        {
            this.texture = new Texture2D(device, CameraTextureDescriptors.DynamicRGB);
